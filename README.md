...
## 🛠 Technical Skills
- **Languages:** Python
- **Expertise:** Machine Learning, Computer Vision, Natural Language Processing (NLP)

## 🌟 Featured Project

### [MangaTech](https://github.com/kazutaka7158/MangaTech)
A personal favorite, MangaTech is where I explored my interest in AI-powered applications and innovative tech solutions.

### [FaceFilter](https://github.com/kazutaka7158/FaceFilter)
A personal project that I build to be a template for machine learning project to train models.
